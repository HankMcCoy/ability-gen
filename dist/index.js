...
/***/ function(module, exports, __webpack_require__) {
	...
	var AbilityGen = _interopRequire(__webpack_require__(1));

	[].forEach.call(document.querySelectorAll(".ability-gen-container"), function (el) {
	  React.render(React.createElement(AbilityGen, null), el);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AbilityGen = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      { className: "ability-gen" },
	      React.createElement(
	        "div",
	        { className: "ability-gen__points-left" },
	        "Points left: ",
	        this.getPointsLeft()
	      ),
	  ...
	  renderAbility: function renderAbility(ability) {
	    return React.createElement(
	      "label",
	      null,
	      ability.toUpperCase(),
	  ...
	  getPointsLeft: function getPointsLeft() {
	    var scores = this.state.scores;
	    var totalCost = Object.keys(scores).map(function (key) {
	      return internal.abilityCosts[scores[key]];
	  ...
	  getAbilityChangeHandler: function getAbilityChangeHandler(ability) {
	    return (function handleAbilityChange(e) {
	      ...
	      if (val !== this.state.scores[ability]) {
	        this.setState({
	          scores: Object.assign({}, this.state.scores, _defineProperty({}, ability, val))
	        });
	      }
	    }).bind(this);
	  }
	...
	module.exports = AbilityGen;

/***/ },
/* 2 */
/***/ function(module, exports, __webpack_require__) {

	/* WEBPACK VAR INJECTION */(function(global) {__webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(26)
	  , setTag   = __webpack_require__(27).set
	...
	var symbolStatics = {
	  ...
	  keyFor: __webpack_require__(31).call(__webpack_require__(32), SymbolRegistry, 0),
	  pure: uid.safe,
	  set: $.set,
	...
	$.each.call($.a('hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'),
	  function(it){
	    symbolStatics[it] = __webpack_require__(33)(it);
	  }
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $   = __webpack_require__(26)
	  ...
	  , tmp = {};
	tmp[__webpack_require__(33)('toStringTag')] = 'z';
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P, STRING, {
	  ...
	  codePointAt: __webpack_require__(36)(false),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                = __webpack_require__(26)
	  ...
	  , UNSCOPABLES      = __webpack_require__(33)('unscopables')
	  , assertDefined    = $.assertDefined
	  , toIndex          = $.toIndex
	  , toLength         = $.toLength
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $       = __webpack_require__(26)
	  ...
	  , $def    = __webpack_require__(29)
	  , assert  = __webpack_require__(30)
	  , forOf   = __webpack_require__(38).forOf
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reflect = {
	  ...
	  apply: __webpack_require__(37)(Function.call, apply, 3),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setStatics(keys, length){
	  $.each.call($.a(keys), function(key){
	    if(key in [])statics[key] = __webpack_require__(37)(Function.call, [][key], length);
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $         = __webpack_require__(26)
	  , Iterators = __webpack_require__(38).Iterators
...
/***/ function(module, exports, __webpack_require__) {
	...
	uid.safe = __webpack_require__(26).g.Symbol || uid;
	module.exports = uid;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(26).g
	  , store  = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(C){
	  if($.DESC && $.FW)$.setDesc(C, __webpack_require__(33)('species'), {
	    configurable: true,
	    get: $.that
	  });
	}
